...
class Check_box:
    def __init__(self, arg, screen, surface, pos, value_func):
        ...
        self.image_nonchecked = pygame.image.load(
            "agym/images/check_box_nonactive.png"
        )
        self.image_checked = pygame.image.load(
            "agym/images/check_box_active.png"
        )
...
class Check_box_button:
    def __init__(self, arg, screen, surface, pos, text, value_func):
        ...
        self.check_box = Check_box(
            arg, self.surface, None, (0, 0), value_func_get
        )
